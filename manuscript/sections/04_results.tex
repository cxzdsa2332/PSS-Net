...
\begin{figure}[t]
  ...
  are seed-level values over 30 seeds; summaries show mean $\pm$ s.d.}
  \label{fig:fig1}
\end{figure}
...
\begin{figure}[t]
  ...
  pilot-informed D-optimal design results. Results over 30 seeds.}
  \label{fig:fig2}
\end{figure}
...
\begin{figure}[t]
  ...
  measurement scales. Results over 30 seeds.}
  \label{fig:fig3}
\end{figure}
